...
<head>
    ...
    <title>The Movie | Add new movie</title>
    ...
    <link href="custom/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="custom/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">

    <link href="custom/css/plugins/datapicker/datepicker3.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            @include('backend.dashboard.component.movieaddmain')
